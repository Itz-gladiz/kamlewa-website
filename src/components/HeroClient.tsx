...
export default function HeroClient({ headline, subtext, volunteer, partner }: HeroClientProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div
          className="absolute inset-0 bg-[url('/images/lead_photo.jpg')] bg-cover bg-center bg-no-repeat filter grayscale brightness-50"
        />
