      ...
      {isMenuOpen && (
        <>
          ...
          <motion.div
            ...
            style={{ backgroundColor: 'rgba(0, 0, 0, 0.9)', zIndex: 9998 }}
          ...
          >
            <div className="flex flex-col h-full p-8">
              ...
              <div className="flex items-center justify-between mb-8">
                <Link href="/" className="flex items-center hover:opacity-90 transition-opacity" onClick={() => setIsMenuOpen(false)}>
                ...
                <button onClick={() => setIsMenuOpen(false)} className="text-white hover:text-yellow-400 transition-colors" aria-label="Close menu">
              ...
              >
                {[
                  { href: '/about', label: serverLabels?.about ?? t('about') },
                  { href: '/events-impact', label: serverLabels?.events ?? t('events') },
                  { href: '/community', label: serverLabels?.community ?? t('community') },
                  { href: '/contact', label: serverLabels?.contact ?? t('contact') },
                ].map((item) => (
                  <motion.div
                    key={item.href}
                    variants={{
                  ...
                  >
                    ...
                    >
                      ...
                      {isActive(item.href) && (
                        <span className="absolute bottom-0 left-0 w-[10%] md:w-1/2 h-0.5 bg-yellow-400" />
                      )}
                    </Link>
                  </motion.div>
                ))}
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className={`p-3 transition-all duration-200 cursor-pointer ${
                      locale === 'en' ? 'bg-yellow-400 ring-2 ring-yellow-400' : 'opacity-70 hover:opacity-100 hover:bg-white/10'
                    }`}
                  ...
                  <button
                    ...
                    className={`p-3 transition-all duration-200 cursor-pointer ${
                      locale === 'fr' ? 'bg-yellow-400 ring-2 ring-yellow-400' : 'opacity-70 hover:opacity-100 hover:bg-white/10'
                    }`}
        ...
        <div className="w-full max-w-7xl mx-auto px-6 py-6 md:px-12 lg:px-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            {[
              ...
              { href: '/events-impact', label: t('events') },
              ...
              <Link
                ...
                className={`relative transition-colors duration-200 text-sm lg:text-base ${
                  isActive(item.href) ? 'text-yellow-400 font-semibold' : 'text-white hover:text-yellow-400'
                }`}
              >
            ...
            <div className="flex items-center gap-2 border-l border-white/20 pl-4 ml-2">
              ...
              <div className="relative">
                {locale === 'en' && <div className="absolute inset-0 bg-white translate-x-0.5 translate-y-0.5" />}
                <button
                  onClick={() => switchLocale('en')}
                  className={`relative p-1.5 transition-all duration-200 cursor-pointer ${
                    locale === 'en' ? 'bg-yellow-400' : 'opacity-70 hover:opacity-100 hover:bg-white/10'
                  }`}
                  aria-label="Switch to English"
                >
              ...
              {/* FR */}
              <div className="relative">
                {locale === 'fr' && <div className="absolute inset-0 bg-white translate-x-0.5 translate-y-0.5" />}
                <button
                  onClick={() => switchLocale('fr')}
                  className={`relative p-1.5 transition-all duration-200 cursor-pointer ${
                    locale === 'fr' ? 'bg-yellow-400' : 'opacity-70 hover:opacity-100 hover:bg-white/10'
                  }`}
                  aria-label="Switch to French"
                >
          ...
          >
            ...
            >
              <path
                ...
                style={{ transform: isMenuOpen ? 'rotate(112.5deg) translate(-27.2%, -80.2%)' : undefined }}
              ...
              <path
                className="transition-transform duration-[350ms] ease"
                style={{ transform: isMenuOpen ? 'rotate(22.5deg) translate(15.5%, -23%)' : undefined }}
              ...
              <path
                className="transition-transform duration-[350ms] ease"
                style={{ transform: isMenuOpen ? 'rotate(112.5deg) translate(-15%, -149.5%)' : undefined }}
