...
export async function POST(req: Request) {
  try {
    const { name, email, phone, expertise, availability, message } = await req.json();

    await resend.emails.send({
      from: 'KAMLEWA Technologies <noreply@kamlewa.org>',
      to: email,
      subject: 'Your Volunteer Application – KAMLEWA Technologies',
      html: `
        <!DOCTYPE html>
        <html lang="en">
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
                  ...
                  <tr>
                    <td style="background-color:#1b1b1b;padding:40px;">
                      <p style="margin:0 0 8px;font-size:13px;font-weight:600;color:#facc15;text-transform:uppercase;letter-spacing:2px;">Volunteer Application</p>
                      ...
                      <p style="margin:0 0 24px;font-size:15px;color:#d1d5db;line-height:1.7;">
                        We've received your volunteer application and are excited about your interest in joining the KAMLEWA community. Our team will review your application and get back to you shortly.
                      </p>
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#0a0a0a;border:1px solid #2d2d2d;margin-bottom:28px;">
                        <tr>
                          <td style="padding:20px 24px;border-bottom:1px solid #2d2d2d;">
                            <p style="margin:0 0 4px;font-size:11px;color:#6b7280;text-transform:uppercase;letter-spacing:1px;">Application Summary</p>
                          </td>
                        </tr>
                        <tr>
                          <td style="padding:20px 24px;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                              ...
                              ${expertise ? `
                              <tr>
                                <td style="padding:6px 0;font-size:13px;color:#6b7280;">Expertise</td>
                                <td style="padding:6px 0;font-size:13px;color:#f9fafb;font-weight:600;">${expertise}</td>
                              </tr>` : ''}
                              ${availability ? `
                              <tr>
                                <td style="padding:6px 0;font-size:13px;color:#6b7280;">Availability</td>
                                <td style="padding:6px 0;font-size:13px;color:#f9fafb;font-weight:600;">${availability}</td>
                              </tr>` : ''}
                              <tr>
                      ...
                      <p style="margin:0 0 32px;font-size:14px;color:#9ca3af;line-height:1.7;">
                        In the meantime, feel free to explore our communities and programs at
